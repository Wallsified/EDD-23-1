...
/**
 * <p>
 * Interface para colecciones, con operaciones para agregar y eliminar
 ...
 *
 * <p>
 * Las colecciones no aceptan a <code>null</code> como elemento; el
 * comportamiento de las clases que implementen esta interfaz no está definido
 * si <code>null</code> es pasado como parámetro a ninguno de sus métodos.
 * </p>
 * 
